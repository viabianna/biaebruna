...
plot( colheita ~ preco, 
      xlab = "Preco (escudos/litro)",
      ylab = "Colheita (em milhares de hectolitros)",
...
```{r}
qqnorm(residuos, 
       main = "Gr?fico de probabilidades normais", 
...
#Questão 4
<br />
  Ao se fazer um diagnóstico binário, no qual Y assume apenas dois valores (positivo e negativo), queremos uma regra de predição que minimize os erros cometidos. Se tomarmos $\pi =1$ por exemplos, nosso Ŷ sempre será positivo. Isso irá maximizar o diagnóstico de verdadeiros positivos, mas também irá minimizar o diagnóstico dos quadros negativos, ou seja, também teremos muitos falsos positivos.<p>
  Para a escolha do valor de $\pi$ é utilizada a curva ROC (do inglês Receiver Operating Characteristic - Característica de operação do receptor). Esta curva apresenta em seu eixo vertical $P(Ŷ=1|Y=1)$ - chamado sensibilidade -  e em seu eixo horizontal $1-P(Ŷ=0|Y=0)$ - chamado especificidade.