...
<p>
```{r}
equação <- (lm(dados$peso~dados$pc))
equação
```
...
<p>
$y= 202.800*3000 - 3683.4$
<p>
$y= 604716.600$
<p>

```{r}
equação <- (lm(dados$est~dados$pc))
equação
```
