...
\hypersetup{breaklinks=true,
            ...
            pdfauthor={Bruna Umino, Beatriz Vianna (IME - USP)},
             pdfkeywords = {},  
            pdftitle={Estatística Descritiva - lista 3},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\NormalTok{dados <-}\StringTok{ }\KeywordTok{read.csv2}\NormalTok{(}\StringTok{"dadosmalariaCEA15P14.csv"}\NormalTok{)}
...
\includegraphics{versaofinal_lista3_files/figure-latex/unnamed-chunk-16-1.pdf}
...
\includegraphics{versaofinal_lista3_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\newpage
\singlespacing 
\bibliography{/home/jtrecenti/Dropbox/master.bib}
